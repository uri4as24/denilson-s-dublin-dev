            ...
            <div className="space-y-8">
              {experience.map((role, index) => (
                <div key={role.id} className="relative pl-16 sm:pl-20">
                  {/* Timeline dot */}
                  <div className="absolute left-4 sm:left-6 top-8 w-4 h-4 rounded-full bg-primary border-4 border-background z-10" />

                  <article className="glass-panel-solid rounded-xl p-6 sm:p-8">
