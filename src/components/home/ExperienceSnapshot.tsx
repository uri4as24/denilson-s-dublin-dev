        ...
        <div className="relative">
          ...
          <div className="space-y-6">
            {latestExperience.map((role, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-4 top-6 w-4 h-4 rounded-full bg-primary border-4 border-background hidden sm:block" />

                <article className="glass-panel-solid rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 sm:hidden">
